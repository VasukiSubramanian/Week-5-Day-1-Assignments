...
public class UpdateIncident extends BaseIncident {
	...
	public void runupdateIncident() throws InterruptedException {
		...
		System.out.println("Incident to be updated : " + CreateIncident.incidentNumber);
		...
		search.sendKeys(CreateIncident.incidentNumber);
		...
		if (urgency1.getText().equals("1 - High"))
			System.out.println("Urgency of Incident " + CreateIncident.incidentNumber + " is set to High");
		else
			System.out.println("Urgency of Incident " + CreateIncident.incidentNumber + " is not set to High");
		...
		if (state1.getText().equals("In Progress"))
			System.out.println("State of Incident " + CreateIncident.incidentNumber + " is set to In Progress");
		else
			System.out.println("State of Incident " + CreateIncident.incidentNumber + " is not set to In Progress");
	}
