...
public class DeleteIncident extends BaseIncident {
	...
	public void runAssignIncident() throws InterruptedException {
		...
		System.out.println("Incident to be deleted : " + CreateIncident.incidentNumber);
		...
		if (records.equals("0"))
			System.out.println("Incident " + CreateIncident.incidentNumber + " deleted successfully");
		else
			System.out.println("Incident " + CreateIncident.incidentNumber + " not deleted");
	}
}
