...
public class AssignIncident extends BaseIncident {
	...
	public void runAssignIncident() throws InterruptedException {
		...
		System.out.println("Incident to be assigned : " + CreateIncident.incidentNumber);
		...
		driver.switchTo().frame("gsft_main");
		driver.findElement(By.id("activity-stream-textarea")).sendKeys("Work Notes");
		...
		if (group.equals("Software"))
			System.out.println("Assignment group of Incident " + CreateIncident.incidentNumber + " is Software");
		else
			System.out.println("Assignment group of Incident " + CreateIncident.incidentNumber + " is not Software");
	}
}
